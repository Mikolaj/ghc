                                   ...
                                   Capability *cap  STG_UNUSED)
{
    ...
    dtraceTaskCreate(getTaskSerialisableId(task), (EventCapNo)cap->no);
}
                                    ...
                                    Capability *new_cap STG_UNUSED)
{
    ...
    dtraceTaskMigrate(getTaskSerialisableId(task), (EventCapNo)cap->no,
...
INLINE_HEADER void traceTaskDelete(Task *task STG_UNUSED)
{
    ...
    dtraceTaskDelete(getTaskSerialisableId(task));
}
